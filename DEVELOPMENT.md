...
Quick reference for developing the Addon.
...
```bash
# Clone repository
git clone https://github.com/openshift/addon-operator.git
cd addon-operator
...
go test ./controllers/addon/...  # Test specific package
...
```bash
# Run specific test
ginkgo -focus="NetworkPolicy" ./controllers/addon/

# Run tests for one package
go test -v ./controllers/addon/
...
- **Controllers**: `controllers/{addon,addoninstance}/` - Reconciliation logic
- **Business Logic**: `controllers/addon/` - Resource management
