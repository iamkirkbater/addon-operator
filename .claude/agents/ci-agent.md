...
- `addon-operator-pull-request.yaml`: PR validation
- `addon-operator-push.yaml`: Main branch builds
- `addon-operator-pko-pull-request.yaml`: PKO validation
- `addon-operator-pko-push.yaml`: PKO deployment
...
# tkn pipeline validate -f .tekton/addon-operator-pull-request.yaml
...
```text
CI Status: FAILING
Pipeline: addon-operator-pull-request
Stage: golangci-lint
Error: Exit code 1
